...
For the vanilla UI, you also have to install [osc.lua](https://github.com/l-jared/thumbfast/blob/vanilla-osc/player/lua/osc.lua) (identical to the mpv default, with added thumbfast support) into your `scripts` folder.  
...
- [osc.lua](https://github.com/l-jared/thumbfast/blob/vanilla-osc/player/lua/osc.lua) (use this fork for vanilla UI)
- [progressbar](https://github.com/torque/mpv-progressbar)
- [tethys](https://github.com/Zren/mpv-osc-tethys) (PR pending, [lua](https://github.com/l-jared/mpv-osc-tethys/blob/thumbfast/osc_tethys.lua))
